...
input ENUM_APPLIED_PRICE SourcePrice = PRICE_CLOSE; // Price source for calculations
input bool   TakeWicksIntoAccount = true;       // Include wicks in calculations
input ENUM_TIMEFRAMES CustomTimeframe = PERIOD_M1;
//--- Indicator Handles ---
...
int OnInit()
{
    ...
    atrHandle = iATR(NULL, CustomTimeframe, ATRPeriod);
